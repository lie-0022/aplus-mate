...
const STEPS = [
  {
    icon: BookOpen,
    title: "1. 수업 찾고 담아두기",
    body: "교수님이 알려준 수업 코드를 입력하거나, 수업 검색에서 학과·구분으로 찾아 등록해요. 등록하면 같은 수업 학생들과 연결돼요. 다음 학기에 들을까 고민되는 수업은 별표(⭐)를 눌러 '관심' 탭에 담아두면 후기와 함께 나중에 비교하기 좋아요.",
    action: { label: "수업으로 가기", path: "/courses" },
  },
  {
    icon: Star,
    title: "2. 수업 후기 남기고 확인하기",
    body: "이 수업에 팀플이 있었는지, 보통 몇 명이서 하는지, 어떤 유형인지, 미리 짠 팀을 교수님이 허용하는지 — 수강생들이 남긴 후기로 미리 파악해요. 지난 학기에 들었던 수업이라면 수업 상세에서 '들었어요·후기 남기기'로 바로 남길 수 있어요(별점·한줄평, 익명). 도움이 된 후기엔 '도움돼요'를 누르면 좋은 후기가 위로 올라가요. 내가 쓴 후기는 프로필에서 모아볼 수 있어요.",
    action: { label: "내 후기 보기", path: "/profile" },
  },
  {
    icon: CalendarDays,
    title: "3. 내 시간표 채우기",
